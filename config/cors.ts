...
const corsMiddleware: RequestHandler = cors({
    origin: ["https://sbiea.co.in", "https://www.sbiea.co.in", "https://admin.sbiea.co.in", "https://institution.sbiea.co.in", "https://student.sbiea.co.in", "http://localhost:5173"], // Allow requests from these origins
